...
public class VoronoiViewer {
    ...
    private static final Timer t = new Timer(5, (ActionEvent ae) -> {
    ...
    public static void main(String[] args) {
        ...
        final JTextField textInput = new JTextField(Integer.toString(component.getMinkowskiCoefficient()));
        textInput.setColumns(3);
        textInput.setFont(boldFont);

        distancePanel.add(textInput);
        ...
        textInput.addActionListener((ActionEvent ae) -> {
            int input = 2;
            try {
                input = Integer.parseInt(textInput.getText());
            } catch (NumberFormatException nfe) {
                JOptionPane.showMessageDialog(null, "Distance Metric can only be an "
                        + "integer greater than 0.", "Invalid Input",
