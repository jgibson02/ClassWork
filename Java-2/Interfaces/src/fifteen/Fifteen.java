...
/**
 * Manages the state of the Fifteen Puzzle. A 4x4 grid contains 15 numbered tiles and an empty 
 * space. The goal is to repeatedly slide a tile into the empty space until the tiles appear in 
 * order.
 * 
 * @author John Gibson
 */
public class Fifteen {
    ...
    /**
     * Moves a specified tile into the adjacent empty space. If the empty space is not adjacent, the
     * method terminates without changing the state of the game.
     */
    public boolean slide(int tileToSlide) {
    ...
    /**
     * Moves the tile at (row, col) into the empty space. If this is not a legal move, the
     * methods ends without change the state of the object.
     */
